...
let slider_about = new Swiper('.sect-fast__3', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
...
document.querySelector('#One').style.setProperty('--animate-duration','.55s');
document.querySelector('#Two').style.setProperty('--animate-duration','.95s');
document.querySelector('#Three').style.setProperty('--animate-duration','1.35s');
document.querySelector('#Four').style.setProperty('--animate-duration','1.75s');
